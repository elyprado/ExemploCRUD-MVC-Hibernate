	 ...
	 public static SessionFactory getSessionFactory() {
	  if (sessionFactory == null) {
	   try {
	    ...
	    settings.put(Environment.URL, "jdbc:mysql://localhost:3366/minierp?useSSL=false");
	    settings.put(Environment.USER, "ely");
	    ...
	    configuration.addAnnotatedClass(Profissao.class);
